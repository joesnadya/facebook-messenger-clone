      ...
      appBar: new AppBar(
        ...
        leading: Container(
          ...
          child: CircleAvatar(
            ...
            child: ClipOval(
              child: Image.asset(
                "assets/profile-picture/${profilePicture[1]}",
                fit: BoxFit.fill,
              ),
            ),
          ),
                          ...
                          Container(
                            ...
                            child: ClipOval(
                              child: (index == 0)
                                  ...
                                  : Image.asset(
                                      "assets/profile-picture/${profilePicture[index]}",
                                    ),
                            ),
                          ),
                          Positioned(
        ...
        child: Row(
          ...
          children: <Widget>[
            Stack(
              children: <Widget>[
                Container(
                  ...
                  child: IconButton(
                    icon: Image.asset(
                      "assets/profile-picture/message.png",
            ...
            Container(
              ...
              child: IconButton(
                icon: Image.asset(
                  "assets/profile-picture/people.png",
                  fit: BoxFit.fitHeight,
                ),
                onPressed: () {},
              ),
            ...
            Container(
              ...
              child: IconButton(
                icon: Image.asset(
                  "assets/profile-picture/navigation.png",
                  fit: BoxFit.fitHeight,
                ),
                onPressed: () {},
              ),
